...
, proto: {
  ...
  , _fetchAndCompileQueryData: function (queryTuple, opts) {
      ...
      this._fetchQueryData(queryTuple, function (err, result, version) {
        ...
        var path;
        // If queryTuple included non-defined motifs, then we can't really
        // work with queryJson
        if (queryJson === null) return finish();
        ...
        finish(null, queryJson.type === 'findOne' || queryJson.type === 'one');
      });
    }
