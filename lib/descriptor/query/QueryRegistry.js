...
, remove: function (queryTuple) {
    ...
    for (var i = tags.length; i--; ) {
      ...
      if (queryIds) { // If the last query for this tag is unsubscribed twice, this won't exist
    ...
    if (queryIds) { // If the last query for this ns is unsubscribed twice, this won't exist
