...
exports.noCurrResultOnDelete = true;  // Ugly hack to avoid refList warnings; otherwise, scope.js would get() our refList when the domain is missing an item
exports.hasRef = true;                // We have a refList pointing to the query ns, so there is no need to handle its pings
