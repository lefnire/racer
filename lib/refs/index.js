...
, proto: {
  ...
  , setRefGetter: function (path, getter) {
      ...
      this.once('beforeTxn', function (method, args) {
  ...
  , _createFn: function (path, inputs, fn, destroy) {
      ...
      // TODO: Use onPath() listeners (for parents, self, and children of each input, as well as self & parents of path)
      ...
      function cleanup() {
        ...
        self.removeListener('bulkUpdate', updateVal);
        destroy && destroy();
